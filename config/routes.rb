Rails.application.routes.draw do
  ...
  get "/docs/agent/v3/buildkite-hosted/remote-docker-builders",                                      to: redirect("/docs/agent/v3/buildkite-hosted/linux/remote-docker-builders")
  ...
  get "/docs/agent/v3/github-ssh-keys",                                                              to: redirect("/docs/agent/v3/self-hosted/code-access#ssh-keys-for-github")
  ...
  get "/docs/agent/v3/queues/managing/pausing-and-resuming",                                         to: redirect("/docs/agent/v3/self-hosted/pausing-and-resuming")
  ...
  get "/docs/agent/v3/pausing-and-resuming",                                                         to: redirect("/docs/agent/v3/self-hosted/pausing-and-resuming")
  get "/docs/agent/v3/plugins",                                                                      to: redirect("/docs/pipelines/integrations/plugins")
  get "/docs/agent/v3/self-hosted/github-ssh-keys",                                                  to: redirect("/docs/agent/v3/self-hosted/code-access#ssh-keys-for-github")
  get "/docs/agent/v3/self-hosted/ssh-keys",                                                         to: redirect("/docs/agent/v3/self-hosted/code-access")
  get "/docs/agent/v3/ssh-keys",                                                                     to: redirect("/docs/agent/v3/self-hosted/code-access")
  get "/docs/agent/v3/tokens",                                                                       to: redirect("/docs/agent/v3/self-hosted/tokens")
  get "/docs/agent/v3/unclustered-tokens",                                                           to: redirect("/docs/agent/v3/self-hosted/tokens#working-with-unclustered-agent-tokens")
  ...
  get "/docs/pipelines/hosted-agents/remote-docker-builders",                                        to: redirect("/docs/agent/v3/buildkite-hosted/linux/remote-docker-builders")
  ...
  get "/docs/pipelines/migration/pipeline-converter",                                                to: redirect("/docs/pipelines/migration/converter")
  ...
  get "/docs/test-engine/bktec/configuring",                                                         to: redirect("/docs/test-engine/bktec")
  get "/docs/test-engine/bktec/installing-the-client",                                               to: redirect("/docs/test-engine/bktec")
  ...
  get "/docs/test-engine/test-splitting/client-installation",                                        to: redirect("/docs/test-engine/bktec")
  get "/docs/test-engine/test-splitting/configuring",                                                to: redirect("/docs/test-engine/bktec")
