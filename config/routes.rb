Rails.application.routes.draw do
  ...
  get "/docs/agent/v3/buildkite-hosted/configure-networking",                                          to: redirect("/docs/agent/v3/buildkite-hosted/network-security")
  get "/docs/agent/v3/buildkite-hosted/internal-container-registries",                                 to: redirect("/docs/agent/v3/buildkite-hosted/internal-container-registry")
  get "/docs/agent/v3/buildkite-hosted/overview",                                                      to: redirect("/docs/agent/v3/buildkite-hosted")
  get "/docs/agent/v3/buildkite-hosted/mac",                                                           to: redirect("/docs/agent/v3/buildkite-hosted/macos")
  get "/docs/agent/v3/buildkite-hosted/mobile-delivery-cloud",                                         to: redirect("/docs/agent/v3/buildkite-hosted/macos")
  get "/docs/agent/v3/buildkite-hosted/mobile-delivery-cloud/getting-started",                         to: redirect("/docs/agent/v3/buildkite-hosted/macos/getting-started-with-ios")
  get "/docs/agent/v3/buildkite-hosted/mobile-delivery-cloud/troubleshooting-fastlane",                to: redirect("/docs/agent/v3/buildkite-hosted/macos/troubleshooting-fastlane")
  ...
  get "/docs/agent/installation",        to: redirect("/docs/agent/v3/install",                              status: 301)
