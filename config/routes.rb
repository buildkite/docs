Rails.application.routes.draw do
  ...
  get "/docs/pipelines/integrations/other/cc-menu",                        to: redirect("/docs/pipelines/integrations/notify/cc-menu")
  get "/docs/pipelines/integrations/other/pagerduty",                      to: redirect("/docs/pipelines/integrations/notify/pagerduty")
  get "/docs/pipelines/integrations/other/slack",                          to: redirect("/docs/pipelines/integrations/notify/slack")
  get "/docs/pipelines/integrations/other/slack-workspace",                to: redirect("/docs/pipelines/integrations/notify/slack-workspace")
