Rails.application.routes.draw do
  ...
  get "/docs/agent/v3/aws/self-serve-installation/ec2-mac",                                          to: redirect("/docs/agent/v3/self-hosted/aws/self-serve-installation/ec2-mac")
  ...
  get "/docs/agent/v3/installation",                                                                 to: redirect("/docs/agent/v3/self-hosted/installing")
  get "/docs/agent/v3/debian",                                                                       to: redirect("/docs/agent/v3/self-hosted/installing/debian")
  get "/docs/agent/v3/docker",                                                                       to: redirect("/docs/agent/v3/self-hosted/installing/docker")
  get "/docs/agent/v3/freebsd",                                                                      to: redirect("/docs/agent/v3/self-hosted/installing/freebsd")
  get "/docs/agent/v3/linux",                                                                        to: redirect("/docs/agent/v3/self-hosted/installing/linux")
  get "/docs/agent/v3/macos",                                                                        to: redirect("/docs/agent/v3/self-hosted/installing/macos")
  get "/docs/agent/v3/redhat",                                                                       to: redirect("/docs/agent/v3/self-hosted/installing/redhat")
  get "/docs/agent/v3/ubuntu",                                                                       to: redirect("/docs/agent/v3/self-hosted/installing/ubuntu")
  get "/docs/agent/v3/windows",                                                                      to: redirect("/docs/agent/v3/self-hosted/installing/windows")
  get "/docs/agent/v3/osx",                                                                          to: redirect("/docs/agent/v3/self-hosted/installing/macos")

  get "/docs/agent/v3/pausing-and-resuming",                                                         to: redirect("/docs/agent/v3/targeting/queues/managing/pausing-and-resuming")
  get "/docs/agent/v3/plugins",                                                                      to: redirect("/docs/pipelines/integrations/plugins")
  get "/docs/agent/v3/queues",                                                                       to: redirect("/docs/agent/v3/targeting/queues")
  ...
  get "/docs/agent/v3/upgrading",                                                                    to: redirect("/docs/agent/v3/self-hosted/installing#upgrade-agents")
  ...
  get "/docs/clusters/manage-queues",                                                                to: redirect("/docs/agent/v3/targeting/queues/managing")
  ...
  get "/docs/pipelines/clusters/manage-queues",                                                      to: redirect("/docs/agent/v3/targeting/queues/managing")
  ...
  get "/docs/pipelines/hosted-agents/configure-networking",                                          to: redirect("/docs/pipelines/hosted-agents/network-security")
  get "/docs/pipelines/hosted-agents/internal-container-registries",                                 to: redirect("/docs/pipelines/hosted-agents/internal-container-registry")
  ...
  get "/docs/pipelines/hosted-agents/mobile-delivery-cloud",                                         to: redirect("/docs/pipelines/hosted-agents/macos")
  get "/docs/pipelines/hosted-agents/mobile-delivery-cloud/getting-started",                         to: redirect("/docs/pipelines/hosted-agents/macos/getting-started-with-ios")
  get "/docs/pipelines/hosted-agents/mobile-delivery-cloud/troubleshooting-fastlane",                to: redirect("/docs/pipelines/hosted-agents/macos/troubleshooting-fastlane")
  ...
  get "/docs/agent/installation",        to: redirect("/docs/agent/v3/installing",                     status: 301)
  get "/docs/agent/ubuntu",              to: redirect("/docs/agent/v3/self-hosted/installing/ubuntu",  status: 301)
  get "/docs/agent/debian",              to: redirect("/docs/agent/v3/self-hosted/installing/debian",  status: 301)
  get "/docs/agent/redhat",              to: redirect("/docs/agent/v3/self-hosted/installing/redhat",  status: 301)
  get "/docs/agent/freebsd",             to: redirect("/docs/agent/v3/self-hosted/installing/freebsd", status: 301)
  get "/docs/agent/osx",                 to: redirect("/docs/agent/v3/self-hosted/installing/macos",   status: 301)
  get "/docs/agent/windows",             to: redirect("/docs/agent/v3/self-hosted/installing/windows", status: 301)
  get "/docs/agent/linux",               to: redirect("/docs/agent/v3/self-hosted/installing/linux",   status: 301)
  get "/docs/agent/docker",              to: redirect("/docs/agent/v3/self-hosted/installing/docker",  status: 301)
