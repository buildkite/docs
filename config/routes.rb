Rails.application.routes.draw do
  ...
  get "/docs/agent/v3/elastic-ci-stack-for-ec2-mac/troubleshooting",                     to: redirect("/docs/agent/v3/aws/elastic-ci-stack/ec2-mac/troubleshooting")
  get "/docs/agent/v3/elastic-ci-aws",                                                   to: redirect("/docs/agent/v3/aws/elastic-ci-stack/ec2-linux-and-windows/setup")
  get "/docs/agent/v3/elastic-ci-aws/cloudformation-service-role",                       to: redirect("/docs/agent/v3/aws/elastic-ci-stack/ec2-linux-and-windows/setup#cloudformation-service-role")
  get "/docs/agent/v3/aws/elastic-ci-stack/ec2-linux-and-windows/cloudformation-service-role", to: redirect("/docs/agent/v3/aws/elastic-ci-stack/ec2-linux-and-windows/setup#cloudformation-service-role")
  ...
  get "/docs/agent/v3/elastic-ci-aws/secrets-bucket",                                    to: redirect("/docs/agent/v3/aws/elastic-ci-stack/ec2-linux-and-windows/security#s3-secrets-bucket")
