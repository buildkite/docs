Rails.application.routes.draw do
  ...
  get "/docs/guides/migrating-from-circleci",       to: redirect("/docs/tutorials/migrating-from-circleci")
  ...
  get "/docs/how-tos/migrating-from-circleci",      to: redirect("/docs/tutorials/migrating-from-circleci")
