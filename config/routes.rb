Rails.application.routes.draw do
  ...
  get "/docs/agent/v3/aws",                               to: redirect("agent/v3/aws")
  get "/docs/agent/v3/aws/secrets-manager",               to: redirect("agent/v3/aws/ec2-linux-and-windows/secrets-manager")
  get "/docs/agent/v3/aws/vpc", to: redirect("/agent/v3/aws/architecture/vpc")
  ...
  get "/docs/agent/v3/elastic-ci-aws", to: redirect("/agent/v3/aws/elastic-ci-stack/ec2-linux-and-windows/setup")
  get "/docs/agent/v3/elastic-ci-aws/cloudformation-service-role", to: redirect("agent/v3/aws/elastic-ci-aws/ec2-linux-and-windows/cloudformation-service-role")
  get "/docs/agent/v3/elastic-ci-aws/elastic-ci-stack-overview", to: redirect("/agent/v3/aws/elastic-ci-stack")
  get "/docs/agent/v3/elastic-ci-aws/managing-elastic-ci-stack", to: redirect("agent/v3/aws/elastic-ci-aws/ec2-linux-and-windows/managing-elastic-ci-stack")
  get "/docs/agent/v3/elastic-ci-aws/parameters",         to: redirect("agent/v3/aws/elastic-ci-aws/ec2-linux-and-windows/parameters")
  get "/docs/agent/v3/elastic-ci-aws/secrets-bucket",     to: redirect("agent/v3/aws/elastic-ci-aws/ec2-linux-and-windows/secrets-bucket")
  get "/docs/agent/v3/elastic-ci-aws/security",           to: redirect("agent/v3/aws/elastic-ci-aws/ec2-linux-and-windows/security")
  get "/docs/agent/v3/elastic-ci-aws/troubleshooting",    to: redirect("agent/v3/aws/elastic-ci-aws/ec2-linux-and-windows/troubleshooting")
