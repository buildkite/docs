...
Once your Java package registry has been [created](/docs/packages/manage-registries#create-a-registry), you can publish/upload packages (generated from your application's build) to this registry by configuring your `build.gradle` file with the Gradle snippet presented on your Java package registry's details page.
...
- URL for your specific Java (Gradle) package registry in Buildkite
    ...
    publishing {
      ...
      repositories {
        maven {
          ...
          credentials {
            username = "package-registry-write-token"
            password = ""
          }
        }
      }
