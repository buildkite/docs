...
<tbody>
  <tr>
    ...
    <td>An attempted agent registration has been blocked because the request IP address is not included in the agent token's <a href="/docs/clusters/manage-clusters#set-up-clusters-restrict-access-for-an-agent-token-by-ip-address">allowed IP addresses</a></td>
  </tr>
</tbody>
</table>
