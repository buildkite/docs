...
> 📘
> This page is about configuring _outgoing webhooks_ for Buildkite Pipelines. To learn more about the Buidlkite platform's _incoming webhooks_ feature, see [Pipeline triggers](/docs/apis/webhooks/incoming/pipeline-triggers).
