...
title: OrganizationRepositoryProvider – Interfaces – GraphQL API
toc: false
---
<!-- vale off -->
<h1 class="has-pills">
...
<table class="responsive-table responsive-table--single-column-rows">
  ...
  <tbody>
    <tr><td><h3 class="is-small has-pills"><code>name</code><a href="/docs/apis/graphql/schemas/scalar/string" class="pill pill--scalar pill--normal-case pill--medium" title="Go to SCALAR String"><code>String!</code></a></h3><p>The name of the OrganizationRepositoryProvider</p></td></tr>
  </tbody>
</table>
