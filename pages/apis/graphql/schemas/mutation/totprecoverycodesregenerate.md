...
<h1 class="has-pills">
  ...
  <span data-algolia-exclude><a href="/docs/apis/graphql/schemas/object/totprecoverycodesregeneratepayload" class="pill pill--object pill--normal-case pill--large" title="Go to OBJECT TOTPRecoveryCodesRegeneratePayload">
...
<table class="responsive-table responsive-table--single-column-rows">
  ...
  <tbody>
    <tr><td><h3 class="is-small has-pills"><code>input</code><a href="/docs/apis/graphql/schemas/input-object/totprecoverycodesregenerateinput" class="pill pill--input_object pill--normal-case pill--medium" title="Go to INPUT_OBJECT TOTPRecoveryCodesRegenerateInput"><code>TOTPRecoveryCodesRegenerateInput!</code></a></h3><p>Parameters for TOTPRecoveryCodesRegenerate</p></td></tr>
  </tbody>
</table>
