...
<h1 class="has-pills" data-algolia-exclude>
  agentTokenRevoke
  <a href="/docs/apis/graphql/schemas/object/agenttokenrevokepayload" class="pill pill--object pill--normal-case pill--large" title="Go to OBJECT AgentTokenRevokePayload"><code>AgentTokenRevokePayload</code></a>

</h1>
<!-- vale on -->


<p>Revoke an agent registration token.</p>
