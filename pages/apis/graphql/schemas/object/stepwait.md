...
<p>A wait step waits for all previous steps to have successfully completed before allowing following jobs to continue</p>
...
<a href="/docs/apis/graphql/schemas/interface/step" class="pill pill--interface pill--normal-case pill--large" title="Go to INTERFACE Step"><code>Step</code></a>
