---
title: JobEventBuildStepUploadCreated – Objects – GraphQL API
toc: false
---
<!--
...
<p>An event created when the job creates new build steps via pipeline upload</p>
