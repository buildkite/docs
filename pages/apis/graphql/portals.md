...
1. Save this portal token to somewhere secure, as you won't be able to access its value again through the Buildkite interface.
    ...
    **Note:** This long-lived service token is scoped to the GraphQL operations defined in this portal. The token allows for the execution of these operations with administrator-level permissions, but cannot perform operations outside those you've explicitly defined.
