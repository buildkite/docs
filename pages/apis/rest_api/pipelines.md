...
- pipelines, along with their [builds](/docs/apis/rest-api/builds) and `tags` (that are a part of the JSON body, with the `tags` key accepting an array of strings, including emojis using the `:emoji:` syntax).
