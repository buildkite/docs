...
<table class="responsive-table responsive-table--wrap-th-codeblocks">
  <tbody>
    ...
    <tr>
      ...
      <td>When using <a href="/docs/pipelines/source-control/github#customizing-commit-statuses">custom commit statuses</a>, prevents any build or step from updating a commit status via <code>notify:</code> using a <code>context:</code> starting with <code>buildkite/</code>. This prevents conflicts with commit statuses automatically generated by Buildkite when <code>publish_commit_status</code> is enabled. When this option is enabled, <code>context:</code> is required for custom commit statuses.
        <p class="Docs__api-param-eg"><em>Values:</em> <code>true</code>, <code>false</code></p>
      </td>
    </tr>
    <tr>
