...
<table class="responsive-table responsive-table--wrap-th-codeblocks">
  <tbody>
    ...
    <tr>
      ...
      <td>Whether to prevent custom commit statuses posted from a pipeline via <a href="/docs/pipelines/source-control/github#customizing-commit-statuses"><code>notify:</code></a> from using a <code>context:</code> starting with <code>buildkite/</code>. Prevents conflicts with commit statuses automatically generated by Buildkite when <code>publish_commit_status</code> is <code>true</code>. When enabled, custom commit statuses must specify a <code>context:</code>.
        <p class="Docs__api-param-eg"><em>Values:</em> <code>true</code>, <code>false</code></p>
      </td>
    </tr>
    <tr>
