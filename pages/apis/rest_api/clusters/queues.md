...
[Pause a queue](/docs/agent/v3/targeting/queues/managing#pause-and-resume-a-queue) to prevent jobs from being dispatched to agents associated with the queue.
