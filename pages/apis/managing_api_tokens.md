...
If you'd like to limit access to your organization by IP address, you can create an allowlist of IP addresses in the [API tab of organization's security settings](https://buildkite.com/organizations/~/security/api).
