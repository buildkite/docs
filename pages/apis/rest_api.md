...
When creating a token, select **Public Key** as the **Credential Type**, then paste the contents of `public_key.pem` into the **RSA public key (PEM)** field. Buildkite accepts RSA keys between 2048 and 4096 bits.
