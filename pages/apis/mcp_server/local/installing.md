...
Once you have installed your _local_ Buildkite MCP server using the relevant instructions on this page, you can proceed to [configure your AI agents](/docs/apis/mcp-server/local/configuring-ai-tools) to work with this MCP server.
