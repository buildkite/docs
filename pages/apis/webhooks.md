...
- Generating chat alerts in Slack that aren't covered by the [Slack Workspace](/docs/pipelines/integrations/notifications/slack-workspace) notification service integration, as well as in other chat applications like Microsoft Teams.
