...
>📘
> User deprovisioning is an Enterprise only feature and is enabled automatically for non custom providers. If you are using a custom provider as an Enterprise customer please contact support@buildite.com to have this feature enabled.
