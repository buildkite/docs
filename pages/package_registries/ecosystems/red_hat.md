...
<%= render_markdown_raw partial: 'package_registries/ecosystems/red_hat_registry_slug' %>
...
<%= render_markdown_raw partial: 'package_registries/ecosystems/path_to_red_hat_package' %>
