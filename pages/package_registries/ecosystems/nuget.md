...
<%= render_markdown_raw partial: 'package_registries/ecosystems/nuget_registry_slug' %>
...
1. Copy the following command, paste it and modify as required before running to add the NuGet registry to your `nuget.config` file:
    ...
    <%= render_markdown_raw partial: 'package_registries/org_slug' %>
    <%= render_markdown_raw partial: 'package_registries/ecosystems/nuget_registry_slug' %>
    <%= render_markdown_raw partial: 'package_registries/ecosystems/nuget_registry_write_token' %>
