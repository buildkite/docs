...
Buildkite Package Registries provides registry support for Docker and Open Container Initiative (OCI) images. These registries follow the [OCI Distribution 1.1 specification](https://github.com/opencontainers/distribution-spec).
