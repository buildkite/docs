...
Buildkite Package Registries provides registry support for Docker images. These registries follow the [OCI Distribution 1.1 specification](https://github.com/opencontainers/distribution-spec).
