...
You can use two approaches to publish an apk package to your Alpine source registry—[`curl`](#publish-a-file-using-curl) or the [Buildkite CLI](#publish-a-file-using-the-buildkite-cli).
