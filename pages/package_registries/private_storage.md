...
The following diagram shows how your private storage link interfaces between the Buildkite Package Registries software-as-a-service (SaaS) _control plane_ (which constitutes the [Buildkite Platform](/docs/platform)), and your teams, operating in infrastructure you're in control of.
