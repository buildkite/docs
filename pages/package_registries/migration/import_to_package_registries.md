...
## Importing using the REST API and other methods

To import a package using REST API, use the [publish a package](/docs/apis/rest-api/package-registries/packages#publish-a-package) endpoint.
