...
From the flaky management dropdown, you can resolve your flaky test. Resolving a flaky test will remove the test from **My Assignments**. The flake will still appear on the flaky page, and display a **Marked as resolved** badge within the flaky index. If the test flakes again, it will be considered a **Reoccurring flaky** and will receive a corresponding badge in the index.
