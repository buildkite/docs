...
Buildkite customers on the [Pro or Enterprise](https://buildkite.com/pricing) plans can assign test ownership to [teams](/docs/test-engine/permissions#manage-teams-and-permissions).
