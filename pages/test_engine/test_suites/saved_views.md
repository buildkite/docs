...
Saved views created from any of these locations are shared across your Buildkite organization or test suite and are visible to all users.
...
> 📘
> This feature is only available to users who are Buildkite organization administrators.
...
This view will now be the default **Tests** tab view for all builds in your Buildkite organization.
