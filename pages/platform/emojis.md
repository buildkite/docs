...
Buildkite supports over 300 custom emojis that you can use in your Buildkite [pipelines](/docs/pipelines/configure), including the terminal output of builds, as well as in [test suites](/docs/pipelines/configure/tests/test-suites) and [registries](/docs/package-registries/registries/manage).
