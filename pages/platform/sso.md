...
You can enforce SSO authentication for the entire organization disabling 2FA authentication. This ensures that all users must log in via SSO when accessing the organization.
