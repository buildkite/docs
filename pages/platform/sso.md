...
You can enforce SSO authentication for your entire Buildkite organization by disabling [2FA authentication](/docs/platform/team-management/enforce-2fa) for the Buildkite organization. This ensures that all users must log in using SSO when accessing your Buildkite organization.
