...
You can enforce SSO authentication for the entire organization by disabling 2FA authentication in your organisation settings. This ensures that all users must log in via SSO when accessing the organization.
