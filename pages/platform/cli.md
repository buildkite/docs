...
Once you've installed the Buildkite CLI, you can start using it by typing `bk` at your command line prompt. To learn more about the `bk` command's own comprehensive set of command categories, see the [Command-line reference](/docs/platform/cli/reference).
