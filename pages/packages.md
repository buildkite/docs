...
- Provides registries to store your [packages](/docs/packages#an-introduction-to-packages) and [other package-like file formats](/docs/packages/background) such as container images and Terraform modules.
