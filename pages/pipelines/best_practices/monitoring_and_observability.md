...
- When implementing [telemetry](/docs/agent/v3/self-hosted/tracing#using-opentelemetry-tracing), start by profiling the wait and checkout times for your queues as the biggest, cheapest wins.
...
Establish standardized metrics collection across all pipelines to enable consistent [monitoring](/docs/agent/v3/self-hosted/monitoring) and analysis:
