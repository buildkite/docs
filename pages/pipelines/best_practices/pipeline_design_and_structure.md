...
- Use [auto-retry](/docs/pipelines/configure/retry#retry-attributes-automatic-retry-attributes) strategically to identify _all_ kinds of flakiness - beyond just flaky tests (that can be identified using [Test Engine](/docs/test-engine)).
