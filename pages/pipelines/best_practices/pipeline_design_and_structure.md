...
- Start simple, then evolve:
    ...
    * Move to [dynamic pipelines](/docs/pipelines/configure/dynamic-pipelines) as repositories and requirements grow to avoid YAML sprawl and enable conditional generation of steps at runtime.
- Separate concerns:
...
retry:
  automatic:
    - exit_status: -1        # agent lost/interrupted
    - exit_status: 255       # infrastructure/transient
      limit: 2
  manual:
    permit_on: "failure"
```
...
steps:
  ...
  - wait: ~
    continue_on_failure: true   # surface all security results in one pass
...
## Standardization and reusable modules
