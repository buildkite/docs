...
2. If this is your first template, select _Create a Template_. Otherwise, select _New Template_.
3. Enter the name and description for your new template, update the default step configuration and select _Create Template_ to create the template.
