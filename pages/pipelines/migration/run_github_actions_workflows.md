...
| `runners` | No | Fallback mappings from GitHub runner labels to Buildkite queues and optional Linux images. Agent API runner resolution takes precedence. |
