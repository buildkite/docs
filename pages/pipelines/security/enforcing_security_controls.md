...
- Use ephemeral Buildkite agents (for instance, the [Buildkite Agent Stack for Kubernetes](/docs/agent/v3/agent-stack-k8s)) or tools like [Ansible](https://docs.ansible.com/) or Puppet to force configuration changes on the hosts if they are statically generated.
