...
- Consider using `no-plugins`[agent start option](https://buildkite.com/docs/agent/v3/cli-start#no-plugins) if you would like to prevent the agent from loading any plugins.
