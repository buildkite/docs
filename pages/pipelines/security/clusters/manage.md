...
1. Select **Create Cluster**.
    ...
    The new cluster's page is displayed on its **Queues** page, indicating the cluster's name and its default queue, named **queue**. A default cache registry named **Default** is also created automatically for the cluster. From this page, you can set up one or more additional [queues](/docs/agent/queues/managing) within this cluster.
