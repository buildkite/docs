...
> 📘 Cluster queue limit
> By default, you can create up to 50 queues per cluster. If your organization requires more than 50 queues in a cluster, contact [support@buildkite.com](mailto:support@buildkite.com).
