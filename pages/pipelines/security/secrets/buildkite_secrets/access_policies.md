...
Each claim must specify one or more _conditions_. Conditions can be a single item or lists of strings. When a list of condition strings is provided on a claim, at least one of these condition's values must match for the claim to be met.
