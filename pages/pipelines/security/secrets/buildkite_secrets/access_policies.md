...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>The unique identifier of the cluster queue where the build is running.<br>
    ...
    <tr>
      ...
      <td>The key of the cluster queue where the build is running.<br>
...
# AND
# - cluster_queue_key is "production"
- build_branch: "main"
...
#### Restrict secret access to builds running on a specific cluster queue

```yaml
- cluster_queue_key: "production"
```

#### Restrict secret access to builds running on specific queues by their ID
