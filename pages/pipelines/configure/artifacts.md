...
Usage in Buildkite-managed artifact storage is billed by storage and transfer. For how this is calculated, see [Artifact storage and transfer billing](/docs/platform/artifact-storage-and-transfer-billing).
