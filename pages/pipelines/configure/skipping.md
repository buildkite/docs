...
This feature applies to builds in the _scheduled_ and _creating_ states. This does not affect builds that are already running. To cancel those builds, see [Cancel Intermediate Builds](/docs/pipelines/configure/canceling-builds#cancel-running-intermediate-builds).
