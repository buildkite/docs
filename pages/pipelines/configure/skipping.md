...
This feature applies to builds in the _scheduled_ and _creating_ states. This does not affect builds that are already running. For information on how to cancel such builds, see [Cancel intermediate builds](/docs/pipelines/configure/canceling-builds#cancel-running-intermediate-builds).
