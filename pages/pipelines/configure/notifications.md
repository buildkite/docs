...
Build-level Slack notifications happen at the following [events](/docs/apis/webhooks#events):

* `build finished`
* `build failing`

Step-level Slack notifications happen at the following [events](/docs/apis/webhooks#events):
