...
You can use conditional notifications at the step level to notify only when specific step outcomes occur. This is useful for immediate notifications when individual steps complete:
