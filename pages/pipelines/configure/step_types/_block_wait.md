...
If you need to run a block step after a failed step, set [`soft_fail`](/docs/pipelines/configure/depends-on#allowed-failure-and-soft-fail) on the failing step:
