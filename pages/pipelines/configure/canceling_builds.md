...
This feature applies to builds in the _started_, _failing_, and _blocked_ (running) states. It does not affect builds that are queued but haven't started yet. To skip those builds, see [Skip Intermediate Builds](/docs/pipelines/configure/skipping#skip-queued-intermediate-builds).
