...
Labels are created at the [test suite](/docs/pipelines/glossary#test-suite) level. Therefore, labels belonging to one test suite will not impact the labels associated with other test suites.
...
Using [workflows](/docs/pipelines/configure/tests/workflows), you can automate the addition and removal of labels when a workflow [monitor](/docs/pipelines/configure/tests/workflows/monitors) condition is met.

### Using execution tags

A test execution [tag](/docs/pipelines/glossary#tag) value can be applied as a label on a test.
...
Learn more about test execution tagging in [Tags](/docs/pipelines/configure/tests/test-suites/tags).
