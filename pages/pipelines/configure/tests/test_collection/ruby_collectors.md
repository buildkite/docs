...
Before you start, make sure RSpec runs with access to [CI environment variables](/docs/pipelines/configure/tests/test-collection/ci-environments).
...
If you don't see branch names, build numbers, or commit hashes in the Test Engine UI, then see [CI environments](/docs/pipelines/configure/tests/test-collection/ci-environments) to learn more about exporting your environment to the collector.
...
If you don't see branch names, build numbers, or commit hashes in the Test Engine UI, then see [CI environments](/docs/pipelines/configure/tests/test-collection/ci-environments) to learn more about exporting your environment to the minitest collector.
