...
While most test frameworks have a built-in JUnit XML export feature, these JUnit reports do not provide detailed span information. Therefore, features in Test Engine that depend on span information aren't available when using JUnit as a data source. If you need span information, consider using the [JSON import](/docs/pipelines/configure/tests/test-collection/importing-json) API instead.
...
It's possible to import XML-formatted JUnit (or [JSON](/docs/pipelines/configure/tests/test-collection/importing-json#how-to-import-json-in-buildkite)) test results to Buildkite Test Engine with or without the help of a plugin.
...
To learn more about passing through environment variables to `run_env`-prefixed fields, see the [Buildkite](/docs/pipelines/configure/tests/test-collection/ci-environments#buildkite) or [Other CI providers](/docs/pipelines/configure/tests/test-collection/ci-environments#other-ci-providers) (including manually) on the [CI environments](/docs/pipelines/configure/tests/test-collection/ci-environments) page.
...
If you need to import per-execution level custom tags, consider using [JSON import](/docs/pipelines/configure/tests/test-collection/importing-json).
...
To learn more about passing through environment variables to `run_env`-prefixed fields, see [CI environments > CircleCI](/docs/pipelines/configure/tests/test-collection/ci-environments#circleci) page section.
...
To learn more about passing through environment variables to `run_env`-prefixed fields, see [CI environments > GitHub Actions](/docs/pipelines/configure/tests/test-collection/ci-environments#github-actions) page section.
