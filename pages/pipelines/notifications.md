...
You can only send email notifications on entire pipeline events, specifically upon [`build_failing`](/docs/apis/webhooks#events) and [`build finished`](/docs/apis/webhooks#events).
