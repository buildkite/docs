...
> Branch filters (branch limiting) apply to branch builds only. Builds created for pull requests or merge requests ignore pipeline-level branch filters. Some source control providers support additional branch filtering for pull request builds. For more information, see [Additional branch filtering for pull request builds](/docs/pipelines/configure/workflows/branch-configuration#additional-branch-filtering-for-pull-request-builds).
