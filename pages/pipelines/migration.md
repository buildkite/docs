...
You can immediately start experimenting with the Buildkite pipeline converter through the [CLI](/docs/pipelines/converter#how-to-use-the-buildkite-pipeline-converter) or via an [interactive web-based app](https://buildkite.com/resources/convert/).
