...
To export metrics to external tools or compare cluster insights with other monitoring approaches, see the [monitoring and observability best practices](/docs/pipelines/best-practices/monitoring-and-observability#getting-metrics-out-of-buildkite).
