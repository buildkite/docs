...
In these situations you can use *concurrency gates* to control which jobs run in parallel and which jobs run one at a time. Concurrency gates come in pairs, for it to work, when you open a concurrency gate, you have to close it.
