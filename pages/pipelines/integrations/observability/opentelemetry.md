...
See [Tracing in the Buildkite Agent](/docs/agent/v3/self-hosted/monitoring-and-observing/tracing#using-opentelemetry-tracing).
...
Trace contexts are propagated automatically from a Buildkite Agent to all its child processes. See [Tracing in the Buildkite Agent](/docs/agent/v3/self-hosted/monitoring-and-observing/tracing#using-opentelemetry-tracing-trace-context-propagation).
