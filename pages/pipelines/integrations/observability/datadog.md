...
- Getting agent fleet metrics (queue depth, agent counts) into Datadog using StatsD and DogStatsD, from the [monitoring and observability best practices](/docs/pipelines/best-practices/monitoring-and-observability#agent-metrics-in-datadog).
