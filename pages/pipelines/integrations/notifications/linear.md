...
1. After granting access, you can then configure the [Test Engine workflow Linear action](/docs/pipelines/configure/tests/workflows/actions#creating-a-linear-issue).
