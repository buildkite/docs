...
For production workloads, create a [custom agent image](/docs/agent/buildkite-hosted/linux/custom-base-images). Custom images give you full control over installed packages, security updates, and dependencies.
