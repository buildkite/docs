...
<tr id="step"><th><code>--step string</code> <a class="Docs__attribute__link" href="#step">#</a></th><td><p>The step to update. Can be either its ID (BUILDKITE_STEP_ID) or key (BUILDKITE_STEP_KEY)<br /><strong>Environment variable</strong>: <code>$BUILDKITE_STEP_ID</code></p></td></tr>
