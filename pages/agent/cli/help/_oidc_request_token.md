...
<tr id="subject-claim"><th><code>--subject-claim value</code> <a class="Docs__attribute__link" href="#subject-claim">#</a></th><td><p>An immutable claim to use as the token's subject (e.g. pipeline_id, cluster_id). If omitted, the default compound subject is used.<br /><strong>Environment variable</strong>: <code>$BUILDKITE_OIDC_TOKEN_SUBJECT_CLAIM</code></p></td></tr>
