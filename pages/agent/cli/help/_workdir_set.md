...
<tr id="output-format"><th><code>--output-format string</code> <a class="Docs__attribute__link" href="#output-format">#</a></th><td><p>Output format: quiet (no output), plain, or json (default: "plain")<br /><strong>Environment variable</strong>: <code>$BUILDKITE_AGENT_WORKDIR_SET_OUTPUT_FORMAT</code></p></td></tr>
</table>
