...
<tr id="job"><th><code>--job string</code> <a class="Docs__attribute__link" href="#job">#</a></th><td><p>The job to update. Defaults to the current job<br /><strong>Environment variable</strong>: <code>$BUILDKITE_JOB_ID</code></p></td></tr>
