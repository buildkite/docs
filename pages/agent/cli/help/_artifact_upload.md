...
<tr id="concurrency"><th><code>--concurrency value</code> <a class="Docs__attribute__link" href="#concurrency">#</a></th><td><p>Number of concurrent artifact upload operations (default: 15)<br /><strong>Environment variable</strong>: <code>$BUILDKITE_ARTIFACT_UPLOAD_CONCURRENCY</code></p></td></tr>
