...
<tr id="build"><th><code>--build string</code> <a class="Docs__attribute__link" href="#build">#</a></th><td><p>The build UUID to cancel<br /><strong>Environment variable</strong>: <code>$BUILDKITE_BUILD_ID</code></p></td></tr>
</table>
