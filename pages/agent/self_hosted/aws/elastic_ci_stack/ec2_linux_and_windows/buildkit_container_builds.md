...
You can pass build arguments to customize your build based on Buildkite [metadata](/docs/agent/cli/reference/meta-data) or [environment variables](/docs/pipelines/configure/environment-variables#buildkite-environment-variables).
