...
For a v6 to v7 upgrade, follow the [Elastic CI Stack v6 to v7 upgrade guide](/docs/agent/self-hosted/aws/elastic-ci-stack/ec2-linux-and-windows/v6-v7-upgrade-guide) before using the update commands below. Stack v7 uses Buildkite agent v4 and changes the agent configuration parameters and cancellation timing.
