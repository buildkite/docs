...
Managed License in AWS License Manager. Ensure you [associate your AMI](/docs/agent/self-hosted/aws/elastic-ci-stack/ec2-mac/setup#step-3-associate-your-ami-with-a-self-managed-license-in-aws-license-manager)
...
Ensure your AMI has been [configured to auto-login as the `ec2-user`](/docs/agent/self-hosted/aws/elastic-ci-stack/ec2-mac/setup#step-2-build-an-ami)
in the GUI.
