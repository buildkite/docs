...
Before deploying this template you must [choose a VPC subnet design](/docs/agent/self-hosted/aws/architecture/vpc), and which VPC security groups your instances will belong to.
...
See the [AWS VPC Design documentation](/docs/agent/self-hosted/aws/architecture/vpc) for more
