...
- Secrets, including [SSH keys for source control](/docs/agent/self-hosted/gcp/elastic-ci-stack/terraform#ssh-keys-for-source-control), are configured using Secret Manager.
