  ...
  <tbody>
    <% [
      ...
      },
      {
        flag: "--max-in-flight",
        type: "integer",
        description: "The maximum jobs in flight, where a value of 0 means no maximum. This number includes any pods for Buildkite jobs in states Running, Pending (unschedulable, pulling image, or with containers terminating).",
        default_value: "25"
      },
      {
        flag: "--namespace",
