...
We frequently introduce new experimental features to the agent. See [Agent experiments](/docs/agent/v3/self-hosted/configure/experiments) for the full list of available and promoted experiments.
