...
Available commands are:
  ...
  <a href="/docs/agent/v3/cli-redactor">tool</a>       Utility commands, intended for users and operators of the agent to run directly on their machines, and not as part of a Buildkite job
