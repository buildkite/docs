...
<tr id="literal"><th><code>--literal </code> <a class="Docs__attribute__link" href="#literal">#</a></th><td><p>Disables parsing of the upload paths as glob patterns; each path will be treated as a single literal file path<br /><strong>Environment variable</strong>: <code>$BUILDKITE_AGENT_ARTIFACT_LITERAL</code></p></td></tr>
