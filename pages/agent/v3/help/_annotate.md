...
<tr id="style"><th><code>--style success</code> <a class="Docs__attribute__link" href="#style">#</a></th><td><p>The style of the annotation (success, `info`, `warning` or `error`)<br /><strong>Environment variable</strong>: <code>$BUILDKITE_ANNOTATION_STYLE</code></p></td></tr>
