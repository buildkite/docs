...
<tr id="step"><th><code>--step value</code> <a class="Docs__attribute__link" href="#step">#</a></th><td><p>The step to update. Can be either its ID (BUILDKITE_STEP_ID) or key (BUILDKITE_STEP_KEY)</p><br /><strong>Environment variable</strong>:</b> <code>$BUILDKITE_STEP_ID</code></td>
...
<tr id="append"><th><code>--append </code> <a class="Docs__attribute__link" href="#append">#</a></th><td><p>Append to current attribute instead of replacing it</p><br /><strong>Environment variable</strong>:</b> <code>$BUILDKITE_STEP_UPDATE_APPEND</code></td>
