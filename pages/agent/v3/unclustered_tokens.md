...
In addition to the initial unclustered agent token, the Buildkite agent automatically generates and manages two internal types of tokens during its operation:
