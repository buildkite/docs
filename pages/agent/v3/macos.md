...
The Buildkite Agent is supported on macOS 11 (Big Sur) or newer using Homebrew or our installer script, and supports pre-release versions of both macOS and Xcode.
