...
> 📘 Prefer Terraform?
> This guide uses CloudFormation. If you prefer Terraform, see the [Terraform](/docs/agent/v3/aws/elastic_ci_stack/ec2_linux_and_windows/terraform) setup guide.
