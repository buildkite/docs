...
This file is auto-generated by scripts/generate_agent_experiments.rb.

To update this file:

1. Make changes to the relevant agent files in https://github.com/buildkite/agent
   For content not in that repo, edit it in scripts/generate_agent_experiments.rb
2. Run 'ruby scripts/generate_agent_experiments.rb > pages/agent/v3/self_hosted/configure/experiments.md' from the docs repo root
-->
