...
This page provides guidelines on how to upgrade your Buildkite agents from 3.0-beta and [2.x versions](/docs/agent/v3/self-hosted/versions-directory#agent-versions-2-dot-x) to a [stable 3.x version](/docs/agent/v3/self-hosted/versions-directory).
