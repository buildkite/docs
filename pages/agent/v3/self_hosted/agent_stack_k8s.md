...
- A Kubernetes cluster running version 1.29.0 or later (required for Buildkite Agent Stack for Kubernetes version 0.35.0 and later, which uses native sidecar containers). For older Kubernetes clusters, use Agent Stack for Kubernetes version 0.34.0 or earlier.
