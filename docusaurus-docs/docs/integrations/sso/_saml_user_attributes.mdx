...
<table>
  ...
  <tr>
    ...
    <td>
      A boolean value that describes whether the user should be provisioned with
      admin permissions
      <br />
      <em>Example:</em> true
    </td>
  ...
  <tr>
    ...
    <td>
      A comma separated list of team UUIDs. A team's UUID can be found on the{" "}
      <em>Team Settings</em> page in Buildkite.
      <br />
      <em>Example:</em>{" "}
      <code>
        a1aaaa1a-b2bb-cccc-d4dd-aa2aaa6aaaaa,b5bbbbbb-3aaa-dd1d-aaa1-eee4eee6eeee
      </code>
    </td>
  </tr>
</table>
