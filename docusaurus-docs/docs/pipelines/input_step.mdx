...
<a
  ...
  href="https://github.com/buildkite/input-step-example"
>
  <span class="detail">:pipeline: Input Step Example Pipeline</span>{" "}
...
<table data-attributes>
  <tr>
    ...
    <td>
      The instructional message displayed in the dialog box when the step is
      activated.
      <br />
  ...
  <tr>
    ...
    <td>
      A list of input fields required to be filled out before the step will be
      marked as passed.
      <br />
  ...
  <tr>
    ...
    <td>
      ...
      defining which branches will include this input step in their builds.
      <br />
  ...
  <tr>
    ...
    <td>
      A boolean expression to restrict the running of the step. See{" "}
