...
If you have [Teams](/docs/pipelines/permissions) enabled in your organization, _one_ of the following conditions must be met:
...
<table data-attributes data-attributes-required id="trigger">
  <tr>
    ...
    <td>
      The slug of the pipeline to create a build. You can find it in the URL of
      your pipeline, and it corresponds to the name of the pipeline, converted
      to{" "}
      <a href="https://en.wikipedia.org/wiki/Letter_case#Kebab_case">
        kebab-case
      </a>
      .<br />
...
<table data-attributes>
  <tr>
    ...
    <td>
      An optional map of attributes for the triggered build. Available
      attributes: <code>branch</code>, <code>commit</code>, <code>env</code>,{" "}
      <code>message</code>, <code>meta_data</code>
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td>
      ...
      <br />
      <em>Example:</em> <code>"\:rocket\: Deploy"</code>
      <br />
    </td>
  </tr>
  <tr>
    ...
    <td>
      If set to <code>true</code> the step will immediately continue, regardless
      of the success of the triggered build. If set to <code>false</code> the
      step will wait for the triggered build to complete and continue only if
      the triggered build passed.
      <br />
      <p>
        Note that when <code>async</code> is set to <code>true</code>, as long
        as the triggered build starts, the original pipeline will show that as
        successful. The original pipeline does not get updated after subsequent
        steps or after the triggered build completes.
        <br />
...
<table>
  <tr>
    ...
    <td>
      The message for the build. Supports emoji. Default: the label of the
      trigger step.
      <br />
      <em>Example:</em> <code>"Triggered build"</code>
      <br />
    </td>
  </tr>
  <tr>
    ...
    <td>
      The commit hash for the build. Default: <code>"HEAD"</code>
      <br />
      <em>Example:</em> <code>"ca82a6d"</code>
      <br />
    </td>
  </tr>
  <tr>
    ...
    <td>
      ...
      <br />
      <em>Example:</em> <code>"production"</code>
      <br />
    </td>
  </tr>
  <tr>
    ...
    <td>
      A map of <a href="/docs/pipelines/build-meta-data">meta-data</a> for the
      build.
      <br />
