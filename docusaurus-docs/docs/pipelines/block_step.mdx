...
<a
  class="Docs__example-repo"
  href="https://github.com/buildkite/block-step-example"
>
  <span class="detail">:pipeline: Block Step Example Pipeline</span>{" "}
...
<table data-attributes>
  <tr>
    ...
    <td>
      The instructional message displayed in the dialog box when the unblock
      step is activated.
      <br />
      <em>Example:</em> <code>"Release to production?"</code>
      <br />
  ...
  <tr>
    ...
    <td>
      A list of input fields required to be filled out before unblocking the
      step.
      <br />
  ...
  <tr>
    <td>
      <code>blocked_state</code>
    </td>
    <td>
      <p>
        The state that the build is set to when the build is blocked by this
        block step. The default is passed. When the <code>blocked_state</code>{" "}
        of a block step is set to <code>failed</code>, the step that triggered
        it will be stuck in the <code>running</code> state until it is manually
        unblocked.
        <br />
        <em>Default:</em> <code>passed</code>
        <br />
        <em>Values:</em> <code>passed</code>, <code>failed</code>,{" "}
        <code>running</code>
      </p>
      <p>
        If you're using GitHub, you can also{" "}
        <a href="/docs/integrations/github#customizing-commit-statuses">
          configure which GitHub status
        </a>{" "}
        to use for blocked builds on a per-pipline basis.
      </p>
    </td>
  </tr>
  <tr>
    ...
    <td>
      ...
      defining which branches will include this block step in their builds.
      <br />
  ...
  <tr>
    ...
    <td>
      A list of step keys that this step depends on. This step will only proceed
  ...
  <tr>
    ...
    <td>
      Whether to continue to proceed past this step if any of the steps named in
      the <code>depends_on</code> attribute fail.
      <br />
...
<table>
  <tr>
    ...
    <td>
      The meta-data key that stores the field's input (using the{" "}
      <a href="/docs/agent/v3/cli-meta-data">
        buildkite-agent meta-data command
      </a>
      )<br />
...
<table>
  <tr>
    ...
    <td>
      ...
      <br />
      <em>Example:</em>{" "}
      <code>"What's the code name for this release? \:name_badge\:"</code>
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td>
      A boolean value that defines whether the field is required for form
      submission.
      <br />
...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      <br />
      For 6 or less options they'll be displayed as radio buttons, otherwise
      they'll be displayed in a dropdown box.
      <br />
      If selecting multiple options is permitted the options will be displayed
      as checkboxes.
    </td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td>
      The value to be stored as meta-data (to be later retrieved using the{" "}
      <a href="/docs/agent/v3/cli-meta-data">
        buildkite-agent meta-data command
      </a>
      )<br />
...
<table>
  <tr>
    ...
    <td>
      ...
      <br />
      <em>Example:</em>{" "}
      <code>"Which release stream does this belong in? \:fork\:"</code>
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td>
      ...
      submission.
      <br />
      When this value is set to <code>false</code> and users can only select one
      option, the options display in a dropdown menu, regardless of how many
      options there are.
      <br />
  ...
  <tr>
    ...
    <td>
      ...
      <br />
      When multiple options are selected, they are delimited in the meta-data
      field by a line break (<code>\n</code>)<br />
      <em>Default:</em> <code>false</code>
    </td>
  </tr>
  <tr>
    ...
    <td>
      ...
      <br />
      When <code>multiple</code> is enabled, this can be an array of values to
      select by default.
      <br />
