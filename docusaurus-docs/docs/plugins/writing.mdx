...
> <ul>
>   <li>
>     You can reference the plugin in pipelines using the `user/plugin-name`
>     syntax rather than the full URL.
>   </li>
>   <li>
>     It makes it easier for community members to find and use the plugin if you
>     make it public.
>   </li>
...
<table>
  ...
  <tbody>
    <tr>
      <td>name</td>
      <td>The name of the plugin, in Title Case.</td>
    </tr>
    <tr>
      <td>description</td>
      <td>A short sentence describing what the plugin does.</td>
    </tr>
    <tr>
      <td>author</td>
      <td>
        A URL to the plugin author (for example, website or GitHub profile).
      </td>
    </tr>
    <tr>
      <td>requirements</td>
      <td>
        An array of commands that are expected to exist in the agent's{" "}
        <code>$PATH</code>.
      </td>
    </tr>
    <tr>
      <td>configuration</td>
      <td>
        A <a href="https://json-schema.org">JSON Schema</a> describing the valid
