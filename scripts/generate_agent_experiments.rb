...
def generate_markdown(experiments_data, descriptions)
  ...
  output << ''
  output << 'This file is auto-generated by scripts/generate_agent_experiments.rb.'
  output << ''
  output << 'To update this file:'
  output << ''
  output << '1. Make changes to the relevant agent files in https://github.com/buildkite/agent'
  output << '   For content not in that repo, edit it in scripts/generate_agent_experiments.rb'
  output << "2. Run 'ruby scripts/generate_agent_experiments.rb > pages/agent/v3/self_hosted/configure/experiments.md' from the docs repo root"
  output << '-->'
  output << ''
