...
#
# Usage:
#   ruby scripts/agent_experiments2docs/agent_experiments2docs.rb > pages/agent/v3/self_hosted/configure/experiments.md
#
# Requirements:
#   - Ruby 3.0+
...
def generate_markdown(experiments_data, descriptions)
  ...
  output << ''
  output << 'This file is auto-generated by scripts/agent_experiments2docs/agent_experiments2docs.rb.'
  output << ''
  output << 'To update this file:'
  output << ''
  output << '1. Make changes to the relevant agent files in https://github.com/buildkite/agent'
  output << '   For content not in that repo, edit it in scripts/agent_experiments2docs/agent_experiments2docs.rb'
